<!-- aletheia:begin -->
# Property-Based Test Targets for transform
...
- **Patterns Detected**: 1 (Cross-Format Round-Trip)
...
- Properties test cross-format round-trip: jsonc -> yaml -> jsonc preserves semantic content
...
### prop_jsonc_yaml_jsonc_roundtrip

Cross-format round-trip property: jsonc -> yaml -> jsonc preserves semantic content
